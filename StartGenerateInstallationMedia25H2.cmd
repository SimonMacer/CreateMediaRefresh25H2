...
@echo off
::Menu Section
title Windows 11, version 25H2 Disc Image File Creation (Ver 2025.11.18)!
set /P c=Set Update Mode (Y = All or N = Skip):
if /I "%c%" EQU "Y" goto :KBStart
if /I "%c%" EQU "N" goto :KBSkip
:KBStart
...
set /P k=Do you want to continue? Input [A] to Continue or [C] to Exit:
if /I "%k%" EQU "A" goto :HomeContinue
if /I "%k%" EQU "C" goto :HomeExit
:HomeContinue
echo Update WinPE!
...
set LCUNumber="-1"
set EKBNumber="-1"
set SAFEOSDUNumber="-1"
set SETUPDUNumber="-1"
set DoNetCUNumber="-1"
set OSNumber="26200.1"
goto :HomeStart_sk
